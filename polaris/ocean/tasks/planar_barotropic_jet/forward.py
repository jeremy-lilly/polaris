...
class Forward(OceanModelStep):
    """
    A step for performing forward ocean component runs as part of planar
    ...
    def __init__(self, component, resolution, name='forward', subdir=None,
        ...
        nu : float, optional
            the viscosity (if different from the default for planar
            barotropic jet tests)
        ...
        self.add_yaml_file('polaris.ocean.tasks.planar_barotropic_jet',
                           'forward.yaml')
    ...
    def dynamic_model_config(self, at_setup):
        ...
        dt_per_km = config.getfloat('planar_barotropic_jet', 'dt_per_km')
